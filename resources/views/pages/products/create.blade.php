    ...
    <div class="panel-body">
        {!! Form::open(array('route' => $route.'.store','method'=>'POST','class'=>'form-horizontal','id'=>'form-submit','role'=>'form','enctype'=>'multipart/form-data')) !!}
            ...
            <div class="form-group {{ $errors->has('categories') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    {!! Form::select('categories[]', $categories->pluck('name','id'), null, ['id'=>'categories','class'=>'select2 form-control',  'multiple'=>'multiple']) !!}
                    @if ($errors->has('roles'))
                        <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('price_purchase') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input type="number" min="0" class="form-control" id="price_purchase" name="price_purchase" value="{{ old('price_purchase') ? old('price_purchase') : 0 }}">
            ...
            <div class="form-group {{ $errors->has('price_sales') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input type="number" readonly="readonly" min="0" class="form-control" id="price_sales" name="price_sales" value="{{ old('price_sales') ? old('price_sales') : 0 }}">
            ...
            <div class="form-group {{ $errors->has('price_profit') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input type="number" min="0" max="100" step="any" class="form-control" id="price_profit" name="price_profit" value="{{ old('price_profit') ? old('price_profit') : 0 }}">
            ...
            <div class="form-group {{ $errors->has('stock') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input type="number" min="0" max="100"  class="form-control" id="stock" name="stock" value="{{ old('stock') ? old('stock') : 0 }}">
                    @if ($errors->has('stock'))
                        <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('date_expired') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control input-datepicker" id="date_expired" name="date_expired" value="{{ old('date_expired')  }}">
