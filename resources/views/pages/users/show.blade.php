...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2">Confirmed :</label>
                <div class="col-sm-10">
                    <p class ="form-control-static">{!! $model->confirm == 1 ? '<span class="label label-success"> Yes</span></td>' : '<span class="label label-danger">No</span></td>' !!}</p>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2">Roles :</label>
                <div class="col-sm-10">
                    <p class ="form-control-static">{{ implode(",", json_decode($model->access)) }}</p> 
                </div>
            </div>
        </form>
    </div>
