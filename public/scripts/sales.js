$(document).ready(function() {
    ...
    let modelData = btoa('/App/Models/Transaction');
    let dataTableColumns = [
        { name: 'transactions.invoice_date', data: 'transactions_invoice_date' },
        { name: 'transactions.invoice_number', data: 'transactions_invoice_number' },
        { name: 'customers.name', data: 'customers_name' },
        { name: 'transactions.grandtotal', data: 'transactions_grandtotal' },
        { 
